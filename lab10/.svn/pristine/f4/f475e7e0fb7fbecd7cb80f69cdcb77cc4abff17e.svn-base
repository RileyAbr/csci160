    ...
    */
    public static void Part1(String fileName, String message)
    {
        ...
        try
        {
            ...
            //3
            //Writing down message provided
            pw.print(message);
            
            //Closing down PrintWriter
            pw.close();
        }
  ...
  */
    ...
    public static void Part2()
    {
        try
        {
            //1
            //Opening file
            FileOutputStream fileOut = new FileOutputStream("files/question5/song.txt", true);
            PrintWriter pw2 = new PrintWriter(fileOut);
            
            //2
            //Appending lines to file
            pw2.println("Oh, I'm glad I'm not an Oscar Mayer wiener.");
            pw2.println("That is what I'd never want to be.");
            pw2.println("Cause if I were an Oscar Mayer wiener.");
            pw2.println("There would soon be nothing left of me!");
