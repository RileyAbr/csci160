...
{
    /*  For this portion of the assignment, you will writing a simple method to perform basic reads 
    from a specified file, the name of which will be passed in as an argument to the method below. 
    ...
    */
    public static String Question3(String fileName)
    {
        ...
        try
        {
            ...
            {
                inputLines += fileScanner.nextLine() + "\n";
            }
