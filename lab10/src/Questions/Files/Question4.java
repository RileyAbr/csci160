...
public class Question4 
{
    ...
    */
    public static void Question4()
    {
        try
        {
            FileOutputStream fileOut = new FileOutputStream("files/question4/MySecretsOfTheUniverse.txt", false);
        
            //PrintWriter is like the opposite of Scanner
            PrintWriter secretWriter = new PrintWriter(fileOut);
            
            secretWriter.println("The number 42.");
            secretWriter.println("The Rise and Fall of Ziggy Stardust and the Spiders from Mars.");
            secretWriter.println("Mew is under the truck.");
            
            //Just as you close the Scanner, you close the PrintWriter
            secretWriter.close();
        }
