...
import Questions.ExtraCredit.Melody;
...
public class MelodyTest {
    ...
    @Test
    public void testLoadRests() {
        testMelody = new Melody(new File("res/melodies/rests.txt"));
        Note[] testArray = getNoteArray(testMelody);
        Pitch[] newPitchArray = {Pitch.C, Pitch.R, Pitch.D, Pitch.R, Pitch.E, Pitch.R, Pitch.F};
