...
public class Question4 
{
    public static Object[] question4(Student student1, Student student2)
    {
        ...
        */
        ...
        int student1Total = student1.getExamScore(0);
        int student2Total = student2.getExamScore(0);
        
        for(int i = 0; i < 7; i++)
        {
            int student1TempScore = student1.getExamScore(i + 1);
            int student2TempScore = student2.getExamScore(i + 1);
            
            if(student1TempScore > student1HighestGrade)
            {
                student1HighestGrade = student1TempScore;
            }
            
            if(student2TempScore > student2HighestGrade)
            {
                student2HighestGrade = student2TempScore;
            }
            
            student1Total = student1Total + student1TempScore;
            student2Total = student2Total + student2TempScore;
        }
        ...
        student1AverageGrade = (double)student1Total / 8;
        student2AverageGrade = (double)student2Total / 8;
