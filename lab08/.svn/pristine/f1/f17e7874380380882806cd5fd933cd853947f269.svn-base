...
public class Question2 
{
    ...
    */
    public Object[] Question2()
    {
         ...
         //1
        int[][] footballDowns = new int[111][11];
        
        //2
        double[][] averageNDSnowfall = new double[100][7];
        
        //3
        int[][][] iceCreamSales = new int[3][52][17];
        
        //4
        String[][] dazAlias = new String[3][365];
        
        //5
        double[][][][][] grocerySalesData = new double[10][52][7][10][12];
        
        //6
        Object[] returnArray;
        returnArray = new Object[]{footballDowns, averageNDSnowfall, iceCreamSales,
                                    dazAlias, grocerySalesData};
