...
public class Question2 
{
    ...
    */
    public static Object[] question2(double money, double wager, Boolean outcome)
    {
        ...
        if(outcome == null)
        {
            outcome = randBool.nextBoolean();
        }
        
        if(outcome == true)
        {
            money += wager;
            System.out.println("I\'ve won a " + moneyFormat.format(wager) + " wager and now have " + moneyFormat.format(money) + "!");
        }
        else
        {
            money -= wager;
            System.out.println("I\'ve lost a " + moneyFormat.format(wager) + " wager and now have " + moneyFormat.format(money) + "!");
        }
