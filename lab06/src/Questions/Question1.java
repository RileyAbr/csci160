...
public class Question1 
{
    ...
    */
    public static boolean[] question1(int age, String personName, Student aStudent, boolean a, boolean b)
    {
        ...
        boolean condition3 = (String.valueOf(aStudent.getID()).length() <= 7);
        boolean condition4 = (age >= 18 && age <= 24);
        boolean condition5 = (personName.toLowerCase().charAt(0) == 'a' || personName.toLowerCase().charAt(personName.length()-1) == 'a');
        boolean condition6 = (((aStudent.getExamScore1() + aStudent.getExamScore2() + aStudent.getExamScore3())/3) >= 60);        
        boolean condition7 = (personName.replaceAll(" ", "").length() + aStudent.getName().replaceAll(" ", "").length() < 10 
                || personName.replaceAll(" ", "").length() + aStudent.getName().replaceAll(" ", "").length() > 20 );
